...
app.use(
    session({
        ...
        cookie: {
            httpOnly: true,
            maxAge: 1000 * 60 * 60 * 24 , // le cookies du client se deduit apres 1 jours de non utilisation
        },
        store: MongoStore.create({
            mongoUrl: 'mongodb+srv://fredy:Devesky123@cluster0.tvkw4.mongodb.net/freelost?retryWrites=true&w=majority',
            ttl: 60 * 60 * 24 , //la session est detruite apres 1 jour de non utilisation
